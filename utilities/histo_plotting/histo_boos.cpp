...
int histo_boos() {
  ...
  TFile *tt = new TFile("/data/atlas/atlasdata/micheli/validation/root/"
                        "no_mass_window/ttbar/boosted.root",
                        "READ");
  ...
  TH1D *h_m_h1_sig = new TH1D(
      "h_m_h1_sig", "Signal - Higgs Candidate Mass - Boosted", nbin, xl_m, xu);
  TH1D *h_m_h2_sig =
      new TH1D("h_m_h2_sig", "Mass - Subleading H", nbin, xl_m, xu);
  TH1D *h_m_h1_4b = new TH1D("h_m_h1_4b", "4b - Higgs Candidate Mass - Boosted",
                             nbin, xl_m, xu);
  TH1D *h_m_h2_4b =
      new TH1D("h_m_h2_4b", "Mass - Subleading H", nbin, xl_m, xu);
  TH1D *h_m_h1_tt =
      new TH1D("h_m_h1_tt", "t#bar{t} - Top Quark Candidate Mass - Boosted",
               nbin, xl_m, xu_m);
  TH1D *h_m_h2_tt =
  ...
  c1->Print("boosted_overlaid.pdf(", "pdf");
