...
def main(argv):
    ...
    fileListLocation = "../datasets_to_append/trunk"
    ...
    nnLocation = "/home/paredes/pheno/testnn/pheno_study/analysis/neuralnet/train_all_jets_noTags"
