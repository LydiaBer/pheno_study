...
def main(argv):
    ...
    for analysis in [ "boosted", "intermediate","resolved"]:
        ...
        for iteration in range(0,10):
          ...
          lr = 10**(-random.randint(1,7))
          nds = 10*(random.randint(10,40))
          ...
          plt.savefig("training/acc_" + analysis +"_"+ str(iteration) +".png")
        ...
        print("**********The highest accuracy for "+ analysis +" is: " + str(max_acc*100) + " with LR =  " + str(best_lr) + ", nNodes =  "+ str(best_nds) +", Dropout = "+ str(best_dp))
