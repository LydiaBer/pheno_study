...
#pragma link C++ class BTaggingFat+;
...
namespace ROOT {
   static void *new_BTaggingFat(void *p = 0);
   static void *newArray_BTaggingFat(Long_t size, void *p);
   static void delete_BTaggingFat(void *p);
   static void deleteArray_BTaggingFat(void *p);
   static void destruct_BTaggingFat(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::BTaggingFat*)
   {
      ::BTaggingFat *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::BTaggingFat >(0);
      static ::ROOT::TGenericClassInfo 
         instance("BTaggingFat", ::BTaggingFat::Class_Version(), "modules/BTaggingFat.h", 39,
                  typeid(::BTaggingFat), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::BTaggingFat::Dictionary, isa_proxy, 4,
                  sizeof(::BTaggingFat) );
      instance.SetNew(&new_BTaggingFat);
      instance.SetNewArray(&newArray_BTaggingFat);
      instance.SetDelete(&delete_BTaggingFat);
      instance.SetDeleteArray(&deleteArray_BTaggingFat);
      instance.SetDestructor(&destruct_BTaggingFat);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::BTaggingFat*)
   {
      return GenerateInitInstanceLocal((::BTaggingFat*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::BTaggingFat*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
//______________________________________________________________________________
atomic_TClass_ptr BTaggingFat::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *BTaggingFat::Class_Name()
{
   return "BTaggingFat";
}

//______________________________________________________________________________
const char *BTaggingFat::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::BTaggingFat*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int BTaggingFat::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::BTaggingFat*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *BTaggingFat::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::BTaggingFat*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *BTaggingFat::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::BTaggingFat*)0x0)->GetClass(); }
   return fgIsA;
}
...
//______________________________________________________________________________
void BTaggingFat::Streamer(TBuffer &R__b)
{
   // Stream an object of class BTaggingFat.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(BTaggingFat::Class(),this);
   } else {
      R__b.WriteClassBuffer(BTaggingFat::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_BTaggingFat(void *p) {
      return  p ? new(p) ::BTaggingFat : new ::BTaggingFat;
   }
   static void *newArray_BTaggingFat(Long_t nElements, void *p) {
      return p ? new(p) ::BTaggingFat[nElements] : new ::BTaggingFat[nElements];
   }
   // Wrapper around operator delete
   static void delete_BTaggingFat(void *p) {
      delete ((::BTaggingFat*)p);
   }
   static void deleteArray_BTaggingFat(void *p) {
      delete [] ((::BTaggingFat*)p);
   }
   static void destruct_BTaggingFat(void *p) {
      typedef ::BTaggingFat current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::BTaggingFat
...
"external",
"/cvmfs/sft-nightlies.cern.ch/lcg/nightlies/dev4/Tue/ROOT/v6-14-00-patches/x86_64-slc6-gcc7-opt/include",
"/home/micheli/test_delphes/Delphes-3.4.1/",
0
    };
...
class __attribute__((annotate("$clingAutoload$modules/BTaggingFat.h")))  BTaggingFat;
